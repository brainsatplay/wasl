(() => {
  ...
  var require_util = __commonJS({
    "node_modules/ajv/dist/compile/util.js"(exports) {
      ...
      function checkUnknownRules(it3, schema = it3.schema) {
        const { opts, self: self3 } = it3;
        if (!opts.strictSchema)
          return;
        if (typeof schema === "boolean")
          return;
        const rules = self3.RULES.keywords;
  ...
  var require_applicability = __commonJS({
    "node_modules/ajv/dist/compile/validate/applicability.js"(exports) {
      ...
      function schemaHasRulesForType({ schema, self: self3 }, type) {
        const group = self3.RULES.types[type];
  ...
  var require_keyword = __commonJS({
    "node_modules/ajv/dist/compile/validate/keyword.js"(exports) {
      ...
      function validateKeywordUsage({ schema, opts, self: self3, errSchemaPath }, def, keyword) {
        ...
        if (def.validateSchema) {
          ...
          if (!valid2) {
            const msg = `keyword "${keyword}" value is invalid at path "${errSchemaPath}": ` + self3.errorsText(def.validateSchema.errors);
            if (opts.validateSchema === "log")
              self3.logger.error(msg);
            else
              throw new Error(msg);
          }
        }
  ...
  var require_validate = __commonJS({
    "node_modules/ajv/dist/compile/validate/index.js"(exports) {
      ...
      function schemaCxtHasRules({ schema, self: self3 }) {
        if (typeof schema == "boolean")
          return !schema;
        for (const key in schema)
          if (self3.RULES.all[key])
            return true;
        return false;
      }
      ...
      function checkRefsAndKeywords(it3) {
        const { schema, errSchemaPath, opts, self: self3 } = it3;
        if (schema.$ref && opts.ignoreKeywordsWithRef && (0, util_1.schemaHasRulesButRef)(schema, self3.RULES)) {
          self3.logger.warn(`$ref: keywords ignored in schema at path "${errSchemaPath}"`);
        }
      }
      ...
      function schemaKeywords(it3, types, typeErrors, errsCount) {
        const { gen, schema, data, allErrors, opts, self: self3 } = it3;
        const { RULES } = self3;
    ...
    "node_modules/ajv/dist/vocabularies/core/ref.js"(exports) {
      ...
      var def = {
        ...
        code(cxt) {
          ...
          const { baseId, schemaEnv: env, validateName, opts, self: self3 } = it3;
          const { root } = env;
          if (($ref === "#" || $ref === "#/") && baseId === root.baseId)
            return callRootRef();
          const schOrEnv = compile_1.resolveRef.call(self3, root, baseId, $ref);
          if (schOrEnv === void 0)
  ...
  var require_format = __commonJS({
    "node_modules/ajv/dist/vocabularies/format/format.js"(exports) {
      ...
      var def = {
        ...
        code(cxt, ruleType) {
          const { gen, data, $data, schema, schemaCode, it: it3 } = cxt;
          const { opts, errSchemaPath, schemaEnv, self: self3 } = it3;
          ...
          function validateFormat() {
            const formatDef = self3.formats[schema];
            if (!formatDef) {
              unknownFormat();
              return;
            }
    ...
    "node_modules/ajv-formats/dist/limit.js"(exports) {
      ...
      exports.formatLimitDefinition = {
        ...
        code(cxt) {
          ...
          if (!opts.validateFormats)
            return;
          const fCxt = new ajv_1.KeywordCxt(it3, self3.RULES.all.format.definition, "format");
          if (fCxt.$data)
            validate$DataFormat();
          else
            validateFormat();
          ...
          function validateFormat() {
            ...
            const fmtDef = self3.formats[format];
  ...
  var get2 = async (relPath, relativeTo = "") => {
    ...
    if (!cache[fullPath]) {
      cache[fullPath] = (isJSON ? import(fullPath, { assert: { type: "json" } }) : import(fullPath)).catch((e3) => {
        if (e3.message.includes("Failed to fetch")) {
          throw new Error("404");
        } else
          console.error(`Error loading ${relPath}`, e3, e3.name);
      });
  ...
  function getFnParamInfo(fn2) {
    ...
    matches.forEach((v3) => {
      ...
      try {
        ...
        info.set(name2, {});
        console.warn(`Argument ${name2} could be parsed for`, fn2.toString());
      }
    });
    return info;
  }
  ...
  var remove = (original, search = original, key = original, o3) => {
  ...
  var getSrc = async (target, info, options2, { nodes = void 0, edges = void 0 } = {}) => {
    ...
    for (let output in edges) {
      const getTarget = (o3, str) => o3.graph?.nodes?.[str] ?? o3[str] ?? o3.arguments.get(str);
      let outTarget = nodes;
  ...
  var load = async (urlOrObject, options2 = {}, urlArg = "") => {
    const clonedOptions = Object.assign({ errors: [], warnings: [] }, options2);
    let {
      relativeTo,
      errors,
      warnings
    ...
    if (url) {
      ...
      pkg = await get_default(pkgUrl).catch((e3) => onError(e3, { errors, warnings }));
      if (pkg)
      ...
      if (clonedOptions.filesystem) {
        ...
        if (relativeToResolved) {
          pkg = await get_default(pkgPath).catch((e3) => onError(e3, { errors, warnings }));
          if (pkg)
            object = Object.assign(pkg, isString ? {} : object);
        }
      }
  ...
  var operator = (pressed) => pressed;
  var tagName = "button";
  var innerHTML = "Click Me";
  var attributes = {
    onmousedown: (ev) => {
  ...
  var button_default = operator;

  // ../htil/plugins/ui/plugins/data/index.js
  var data_exports = {};
  ...
  var onrender = (el, props) => {
    element = el;
    self2 = props.node;
    paragraphs = {};
  };
  var data_default = operator2;
  ...
  var Ue = function(t9) {
    function e3(e4, n3) {
      var r3 = t9.call(this, e4) || this;
      return r3.buffer = [], r3.add(re(n3, new ee(r3))), r3;
    }
    return o(e3, t9), e3.prototype._next = function(t10) {
  ...
  var en = function(t9) {
    ...
    return o(e3, t9), e3.prototype._next = function(t10) {
      ...
      t10 = new d(), this.closingSubscription = t10, this.add(t10), this.subscribing = true, t10.add(re(e4, new ee(this))), this.subscribing = false;
    }, e3;
  }(ne);
  var nn = function() {
    function t9(t10) {
  ...
  var an = function(t9) {
    ...
    return o(e3, t9), e3.prototype._next = function(t10) {
      ...
      this.value = t10, this.hasValue = true, n3 && (n3.unsubscribe(), this.remove(n3)), (n3 = re(e4, new ee(this))) && !n3.closed && this.add(this.durationSubscription = n3);
    }, e3.prototype.notifyNext = function() {
      this.emitValue();
    }, e3.prototype.notifyComplete = function() {
      this.emitValue();
  ...
  var Tn = function(t9) {
    function e3(e4, n3, r3) {
      var i3 = t9.call(this, e4) || this;
      return i3.keySelector = n3, i3.values = /* @__PURE__ */ new Set(), r3 && i3.add(re(r3, new ee(i3))), i3;
    }
  ...
  var Bn = function(t9) {
    ...
    return o(e3, t9), e3.prototype._next = function(t10) {
      this.hasSubscription || (this.hasSubscription = true, this.add(re(t10, new ee(this))));
    }, e3.prototype._complete = function() {
  ...
  var qn = function(t9) {
    ...
    return o(e3, t9), e3.dispatch = function(t10) {
      ...
      this.active++, this.destination.add(re(t10, new ee(this)));
    }, e3.prototype._complete = function() {
  ...
  var Sr = function(t9) {
    ...
    return o(e3, t9), e3.prototype.notifyNext = function() {
      ...
      this.retries = e4, this.retriesSubscription = re(e4, new ee(this));
    }, e3;
  }(ne);
  var Er = function() {
    function t9(t10, e3) {
  ...
  var Ir = function() {
    ...
    return t9.prototype.call = function(t10, e3) {
      ...
      return r3.add(re(this.notifier, new ee(n3))), r3;
    }, t9;
  }();
  var Vr = function(t9) {
    function e3() {
  ...
  var Xr = function(t9) {
    ...
    return o(e3, t9), e3.prototype._next = function(t10) {
      ...
      r3.add(n3), this.innerSubscription = re(t10, n3), this.innerSubscription !== n3 && r3.add(this.innerSubscription);
    }, e3.prototype._complete = function() {
      var e4 = this.innerSubscription;
  ...
  var Zr = function() {
    ...
    return t9.prototype.call = function(t10, e3) {
      var n3 = new $r(t10), r3 = re(this.notifier, new ee(n3));
  ...
  var si = function(t9) {
    ...
    return o(e3, t9), e3.prototype._next = function(t10) {
      ...
      e4 && this.add(this._throttled = re(e4, new ee(this)));
  ...
  var pi = function(t9) {
    ...
    return o(e3, t9), e3.dispatchTimeout = function(t10) {
      ...
      t10._unsubscribeAndRecycle(), t10.add(re(e4, new ee(t10)));
  ...
  var vi = function() {
    ...
    return t9.prototype.call = function(t10, e3) {
      ...
      return r3.closed || n3.add(re(this.windowBoundaries, new ee(n3))), r3;
    }, t9;
  }();
  var yi = function(t9) {
    function e3(e4) {
  ...
  var re2 = "function" == typeof Symbol && Symbol.iterator ? Symbol.iterator : "@@iterator";
  function ae2(e3) {
    if (e3 instanceof W2)
      return e3;
    if (null != e3) {
      ...
      if (function(e4) {
        ...
        return oe2(e3);
      if (function(e4) {
        return I2(null == e4 ? void 0 : e4[re2]);
      }(e3))
  ...
  var SerialDevice = class extends Device {
    constructor(constraints) {
      ...
      this.connect = () => __awaiter(this, void 0, void 0, function* () {
        ...
        var re3 = /[0-9A-Fa-f]{6}/g;
        if (!!usbVendorId && typeof usbVendorId !== "string" && !re3.test(usbVendorId + ""))
          usbVendorId = `0x${usbVendorId.toString(16)}`;
        if (!!usbProductId && typeof usbProductId !== "string" && !re3.test(usbProductId + ""))
  ...
  // ../htil/plugins/datastreams/plugins/start/index.js
  var operator3 = async (node, input, ...recursiveData) => {
    if (input === "data")
  ...
  var options = {
    ...
    filesystem: {
      ...
      "plugins/ui/data/index.js": data_exports,
      ...
      "plugins/datastreams/start/index.js": start_exports
    }
  };
  ...
  var start = async () => {
    ...
    if (res) {
      const o3 = await load_default(path, importOptions);
      console.log("wasl.load (import)", o3);
    }
